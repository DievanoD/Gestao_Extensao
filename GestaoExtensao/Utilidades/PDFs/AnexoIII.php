...
$Anexo = '<p id="formularioDeInscricao">ANEXO III<br>
Declaração da Direção Geral</p></center>
...
foram analisados pela Direção Geral do [inserir nome do campus] do Instituto Federal de
Educação, Ciência e Tecnologia do Triângulo Mineiro – IFTM, estando a mesma ciente deste,
tendo em vista o estabelecido no item 1.5 “f” do edital __/____ do Programa de Apoio a
Programas e Projetos de Extensão do Instituto Federal de Educação, Ciência e Tecnologia do
Triângulo Mineiro – IFTM
Para que sejam produzidos todos os efetivos legais, técnicos e administrativos deste
