					...
					<form action="../Controller/UsuarioController.php" method="post" name="FormCadastroAcesso" id="form">
						...
						<div class="row">
							...
							<div class="col-md-4">
								...
								<div class="radio">
								  <label><input type="radio" name="coordenacao" value="sim" required>Sim</label>
								  <label><input type="radio" name="coordenacao" value="nao">Não</label>
								</div>
							</div>
						...
						<div class="row">
							<div class="form-inline alinharTextoCentro">
								...
								<a href="Area_De_Trabalho.php" class="btn btn-success" role="button">Cancelar</a>
							</div>
						</div>
					</form>
				</div>
